...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $id_rak           = mysqli_real_escape_string($mysqli, trim($_POST['rak']));
            ...
            $query = mysqli_query($mysqli, "INSERT INTO is_barang_keluar(id_barang_keluar,tanggal_keluar,id_barang,id_gudang,id_rak,jumlah_keluar,created_user) 
                                            VALUES('$id_barang_keluar','$tanggal_keluar','$id_barang','$id_gudang','$id_rak','$jumlah_keluar','$created_user')")
