...
if ($_GET['form'] == 'add') {
    if (isset($_GET['id'])) {
        ...
        $query = mysqli_query($mysqli, "SELECT a.id_barang_masuk,a.tanggal_masuk,a.jumlah_masuk,a.id_rak,a.id_gudang,
                    ...
                    <form role="form" class="form-horizontal" action="modules/barang-masuk/proses.php?act=insert" method="POST" name="formBarangMasuk">
                        <div class="box-body">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select class="chosen-select" name="rak" data-placeholder="-- Pilih Rak --" autocomplete="off" required>
