...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO is_barang_masuk(id_barang_masuk,tanggal_masuk,id_barang,id_gudang,id_rak,jumlah_masuk,created_user) 
                                            VALUES('$id_barang_masuk','$tanggal_masuk','$id_barang','$id_gudang','$id_rak','$jumlah_masuk','$created_user')")
