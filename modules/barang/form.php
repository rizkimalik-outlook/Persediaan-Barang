...
elseif ($_GET['form'] == 'edit') {
    if (isset($_GET['id'])) {
        ...
        $query = mysqli_query($mysqli, "SELECT a.id_barang,a.kode_barang,a.nama_barang,a.id_jenis,a.id_satuan,b.id_jenis,b.nama_jenis,c.id_satuan,c.nama_satuan 
                    ...
                    <form role="form" class="form-horizontal" action="modules/barang/proses.php?act=update" method="POST">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Kode Barang</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="kode_barang" autocomplete="off" value="<?php echo $data['kode_barang']; ?>" required>
                                </div>
                            </div>
