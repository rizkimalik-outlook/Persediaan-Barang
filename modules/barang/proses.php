...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO is_barang(id_barang,kode_barang,nama_barang,id_jenis,id_satuan,created_user,updated_user) 
                                            VALUES('$id_barang','$kode_barang','$nama_barang','$id_jenis','$id_satuan','$created_user','$created_user')")
