...
// jika user sudah login, maka jalankan perintah untuk pemanggilan file halaman konten
    ...
    //? jika halaman konten yang dipilih rak, panggil file view rak
	elseif ($_GET['module'] == 'rak') {
		include "modules/rak/view.php";
	}

	//? jika halaman konten yang dipilih form rak, panggil file form rak
	elseif ($_GET['module'] == 'form_rak') {
		include "modules/rak/form.php";
	}
	//? -----------------------------------------------------------------------------

    //? jika halaman konten yang dipilih gudang, panggil file view gudang
	elseif ($_GET['module'] == 'gudang') {
		include "modules/gudang/view.php";
	}

	//? jika halaman konten yang dipilih form rak, panggil file form rak
	elseif ($_GET['module'] == 'form_gudang') {
		include "modules/gudang/form.php";
	}
	//? -----------------------------------------------------------------------------
