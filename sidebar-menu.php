...
if ($_SESSION['hak_akses']=='Super Admin') { ?>
	...
	if ($_GET["module"]=="barang" || $_GET["module"]=="form_barang") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		...
        		<li><a href="?module=rak"><i class="fa fa-circle-o"></i> Rak</a></li>
                <li><a href="?module=gudang"><i class="fa fa-circle-o"></i> Gudang</a></li>
      		</ul>
    	</li>
    <?php
	}
    ...
    //? jika menu Rak dipilih, menu Rak aktif
	elseif ($_GET["module"]=="rak" || $_GET["module"]=="form_rak") { ?>
		<li class="active treeview">
          	<a href="javascript:void(0);">
            	<i class="fa fa-folder"></i> <span>Data Master</span> <i class="fa fa-angle-left pull-right"></i>
          	</a>
      		<ul class="treeview-menu">
        		...
        		<li><a href="?module=jenis"><i class="fa fa-circle-o"></i> Jenis Barang</a></li>
        		<li><a href="?module=satuan"><i class="fa fa-circle-o"></i> Satuan</a></li>
        		<li class="active"><a href="?module=rak"><i class="fa fa-circle-o"></i> Rak</a></li>
                <li><a href="?module=gudang"><i class="fa fa-circle-o"></i> Gudang</a></li>
      		</ul>
    	</li>
    <?php
    ...
    //? jika menu Rak dipilih, menu Rak aktif
	elseif ($_GET["module"]=="gudang" || $_GET["module"]=="form_gudang") { ?>
		<li class="active treeview">
          	<a href="javascript:void(0);">
            	<i class="fa fa-folder"></i> <span>Data Master</span> <i class="fa fa-angle-left pull-right"></i>
          	</a>
      		<ul class="treeview-menu">
        		...
        		<li><a href="?module=satuan"><i class="fa fa-circle-o"></i> Satuan</a></li>
        		<li><a href="?module=rak"><i class="fa fa-circle-o"></i> Rak</a></li>
                <li class="active"><a href="?module=gudang"><i class="fa fa-circle-o"></i> Gudang</a></li>
      		</ul>
    	</li>
    <?php
	}
